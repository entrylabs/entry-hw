...
typedef struct
{
  ...
  __IO uint32_t BDCR;
  __IO uint32_t CSR;//0X24,STM32
  __IO uint32_t AHBRSTR;//0X28,AT32F403A
  __IO uint32_t RESERVED1;//0X2C,AT32F403A
  __IO uint32_t MISC1;//0X30,AT32F403A
  /*
      * @brief crm reserved2 register, offset:0x4C~0x34
    */
  __IO uint32_t reserved2[7];
  __IO uint32_t MISC2;//0X50,AT32F403A
  __IO uint32_t MISC3;//offset:0x54
#ifdef STM32F10X_CL  
