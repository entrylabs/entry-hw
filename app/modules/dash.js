...
var DashParamCmd_Sound_Say =
{
  ...
  //이상한
  BEEPS:24, LASERS:25, GOBBLE:26, BUZZ:27, AYYAIYAI:28, SQUEEL:29
};
    ...
    case DashCategoryCmd.SOUND:
      ...
      switch (a)
      {
        case DashActionCmd_Sound.MY_SOUNDS:
          buffer.push(0x18, 0x53, 0x59, 0x53, 0x54, 0x56, 0x4f, 0x49, 0x43, 0x45, pa+48, 0x00, 0x00, 0x00, 0x00);
          break;
