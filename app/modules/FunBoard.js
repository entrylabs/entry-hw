...
Module.prototype.isRecentData = function(port, type, data) {
    ...
    //if(type==4||type==10||type==12) { if(this.recentCheckData[port].data!=data) isRecent = false; }
...
Module.prototype.makeOutputBuffer = function(device, port, data) {
    ...
    switch (device) {
        ...
        case this.sensorTypes.MATRIX64: {
            var value0 = new Buffer(2);
            var value1 = new Buffer(2);
            var value2 = new Buffer(2);
            var value3 = new Buffer(2);
            var value4 = new Buffer(2);
            var value5 = new Buffer(2);
            var value6 = new Buffer(2);
            var value7 = new Buffer(2);
            var value8 = new Buffer(2);
            if ($.isPlainObject(data)) {
                value0.writeInt16LE(data.value0);
                value1.writeInt16LE(data.value1);
                value2.writeInt16LE(data.value2);
                value3.writeInt16LE(data.value3);
                value4.writeInt16LE(data.value4);
                value5.writeInt16LE(data.value5);
                value6.writeInt16LE(data.value6);
                value7.writeInt16LE(data.value7);
                value8.writeInt16LE(data.value8);
            } else {
                value0.writeInt16LE(0);
                value1.writeInt16LE(0);
                value2.writeInt16LE(0);
                value3.writeInt16LE(0);
                value4.writeInt16LE(0);
                value5.writeInt16LE(0);
                value6.writeInt16LE(0);
                value7.writeInt16LE(0);
                value8.writeInt16LE(0);
            }
            buffer = new Buffer([
                255,
                85,
...
//하드웨어 연결 시, 일정시간동안 하드웨어쪽에서 전송되는 data가 없는 경우에,
//연결이 되지 않았다고 판단하는데...
//이를 체크하는 아래 함수가 아무런 행동을 취하지 않도록...
//!@#$
