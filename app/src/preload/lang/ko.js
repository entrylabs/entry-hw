...
Lang.Msgs = {
    ...
    expansion_behaviorConductLifeSafety_description:
        '생활속에서 안전을 위해 국민이 지켜야하는 기본적인 행동요령에 대한 블록들의 모음입니다. (국민안전처 제공)',
    expansion_tts_description:
        'nVoice를 이용하여 다양한 목소리로 문장을 읽을 수 있는 블록들의 모음입니다.',
};
Lang.Users = {
...
Lang.Helper = {
    ...
    calc_operation:
        '입력한 수에 대한 다양한 수학식의 계산값입니다. (제곱, 루트, 사인값, 코사인값, 탄젠트값, 아크사인값, 아크코사인값, 아크탄젠트값, 로그값, 자연로그값, 소수점 부분, 소수점 버림값, 소수점 올림값, 반올림값, 펙토리얼값, 절대값)',
...
Lang.template = {
    ...
    bitbrick_when_button_pressed: '%1 버튼 %2 눌어졌을 때',
...
Lang.TextCoding = {
    ...
    alert_api_no_support:
        '작품에 확장 블록이 사용된 경우에는 엔트리파이선 모드로 변경할 수 없습니다.',
