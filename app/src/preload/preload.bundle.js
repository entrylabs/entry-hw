...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/src/preload/index.ts");
/******/ })
/************************************************************************/
/******/ ({
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.EntryStatePayload = exports.EntryMessageAction = exports.AvailableTypes = exports.HardwareStatement = exports.CloudModeTypes = exports.RunningModeTypes = void 0;
var RunningModeTypes;
(function (RunningModeTypes) {
    RunningModeTypes[RunningModeTypes["server"] = 2] = "server";
    RunningModeTypes[RunningModeTypes["client"] = 3] = "client";
})(RunningModeTypes = exports.RunningModeTypes || (exports.RunningModeTypes = {}));
var CloudModeTypes;
(function (CloudModeTypes) {
    CloudModeTypes[CloudModeTypes["singleServer"] = 0] = "singleServer";
    CloudModeTypes[CloudModeTypes["cloud"] = 1] = "cloud";
})(CloudModeTypes = exports.CloudModeTypes || (exports.CloudModeTypes = {}));
var HardwareStatement;
(function (HardwareStatement) {
    HardwareStatement["lost"] = "lost";
    HardwareStatement["scan"] = "scan";
    HardwareStatement["disconnected"] = "disconnected";
    HardwareStatement["selectPort"] = "select_port";
    HardwareStatement["flash"] = "flash";
    HardwareStatement["beforeConnect"] = "before_connect";
    HardwareStatement["connected"] = "connected";
    HardwareStatement["scanFailed"] = "scan_failed";
})(HardwareStatement = exports.HardwareStatement || (exports.HardwareStatement = {}));
var AvailableTypes;
(function (AvailableTypes) {
    AvailableTypes["available"] = "available";
    AvailableTypes["needUpdate"] = "needUpdate";
    AvailableTypes["needDownload"] = "needDownload";
})(AvailableTypes = exports.AvailableTypes || (exports.AvailableTypes = {}));
var EntryMessageAction;
(function (EntryMessageAction) {
    EntryMessageAction["init"] = "init";
    EntryMessageAction["state"] = "state";
})(EntryMessageAction = exports.EntryMessageAction || (exports.EntryMessageAction = {}));
var EntryStatePayload;
(function (EntryStatePayload) {
    EntryStatePayload["disconnectHardware"] = "disconnectHardware";
    EntryStatePayload["connected"] = "connected";
})(EntryStatePayload = exports.EntryStatePayload || (exports.EntryStatePayload = {}));


/***/ }),

/***/ "./app/src/preload/bleProcessManager.ts":
/*!**********************************************!*\
  !*** ./app/src/preload/bleProcessManager.ts ***!
  \**********************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var ipcRendererManager_1 = __importDefault(__webpack_require__(/*! ./ipcRendererManager */ "./app/src/preload/ipcRendererManager.ts"));
var BleProcessManager = /** @class */ (function () {
    function BleProcessManager() {
        var _this = this;
        this.ipcManager = new ipcRendererManager_1.default();
        this._readEvents = [];
        this._writeEvents = [];
    ...
    BleProcessManager.prototype._handleScanBleDevice = function (event, options) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            var _c, device, _d, e_1;
            return __generator(this, function (_e) {
                switch (_e.label) {
                    ...
                    case 1:
                        _c.connectedDevice = _e.sent();
                        device = this.connectedDevice;
                        _d = !((_a = device === null || device === void 0 ? void 0 : device.gatt) === null || _a === void 0 ? void 0 : _a.connected);
                        if (!_d) return [3 /*break*/, 3];
                        return [4 /*yield*/, ((_b = device === null || device === void 0 ? void 0 : device.gatt) === null || _b === void 0 ? void 0 : _b.connect())];
                    case 2:
                        _d = (_e.sent());
                        _e.label = 3;
                    case 3:
    ...
    BleProcessManager.prototype._handleConnectBleDevice = function (e, profiles) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, summary_1;
            var _this = this;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        if (!(this.connectedDevice && this.connectedDevice.gatt)) return [3 /*break*/, 3];
                        _a = this;
                        return [4 /*yield*/, this.connectedDevice.gatt.getPrimaryServices()];
                    case 1:
                        _a.bleServices = (_b.sent()) || [];
                        summary_1 = { write: [], read: [] };
                        // 모든 서비스 등록
                        return [4 /*yield*/, Promise.all(profiles.map(function (_a) {
                                var service = _a.service, characteristics = _a.characteristics;
                                return __awaiter(_this, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_b) {
                                        switch (_b.label) {
                                            case 0:
                                                targetService = this.bleServices.find(function (bleService) { return bleService.uuid === service; });
                                                if (!targetService) return [3 /*break*/, 2];
                                                // 모든 특성 등록
                                                return [4 /*yield*/, Promise.all(characteristics.map(function (_a) {
                                                        var key = _a.key, uuid = _a.uuid, _b = _a.type, type = _b === void 0 ? 'read' : _b;
                                                        return __awaiter(_this, void 0, void 0, function () {
                                                            var characteristic;
                                                            return __generator(this, function (_c) {
                                                                switch (_c.label) {
                                                                    case 0: return [4 /*yield*/, targetService.getCharacteristic(uuid)];
                                                                    case 1:
                                                                        characteristic = _c.sent();
                                                                        if (!(type === 'read')) return [3 /*break*/, 3];
                                                                        return [4 /*yield*/, this._registerReadCharacteristic(key, characteristic)];
                                                                    case 2:
                                                                        _c.sent();
                                                                        return [3 /*break*/, 4];
                                                                    case 3:
    ...
    BleProcessManager.prototype._handleWriteBleDevice = function (e, _a) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        characteristic = this._writeEvents.find(function (listener) { return listener.key === key; });
                        if (!characteristic) return [3 /*break*/, 2];
                        return [4 /*yield*/, characteristic.value.writeValue(this._encodeString(value))];
                    case 1:
                        _b.sent();
                        return [3 /*break*/, 3];
                    case 2:
    ...
    BleProcessManager.prototype._handleDisconnectBleDevice = function (e) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_c) {
                this._writeEvents = [];
                (_b = (_a = this.connectedDevice) === null || _a === void 0 ? void 0 : _a.gatt) === null || _b === void 0 ? void 0 : _b.disconnect();
    ...
    BleProcessManager.prototype._registerReadCharacteristic = function (key, characteristic) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.sent();
                        characteristic.addEventListener('characteristicvaluechanged', function (_a) {
                            var target = _a.target;
                            _this.connected && _this.ipcManager.invoke('readBleDevice', key, target.value);
                        });
                        this._readEvents.push({ key: key, value: characteristic });
                        return [2 /*return*/];
                }
            });
        });
    };
    BleProcessManager.prototype._registerWriteCharacteristic = function (key, characteristic) {
        this._writeEvents.push({ key: key, value: characteristic });
    };
    BleProcessManager.prototype._encodeString = function (text) {
...
exports.default = BleProcessManager;
...
var translator_1 = __importDefault(__webpack_require__(/*! ./translator */ "./app/src/preload/translator.ts"));
var rendererRouter_1 = __importDefault(__webpack_require__(/*! ./rendererRouter */ "./app/src/preload/rendererRouter.ts"));
var bleProcessManager_1 = __importDefault(__webpack_require__(/*! ./bleProcessManager */ "./app/src/preload/bleProcessManager.ts"));
var isOSWin64 = function () { return (process.arch === 'x64' ||
    // eslint-disable-next-line no-prototype-builtins
    process.env.hasOwnProperty('PROCESSOR_ARCHITEW6432')); };
function getInitializeList() {
    var rendererRouter = new rendererRouter_1.default();
    var locale = rendererRouter.sharedObject.language;
    var translator = new translator_1.default(locale);
    new bleProcessManager_1.default();
    return {
...
/***/ "./app/src/preload/ipcRendererManager.ts":
/*!***********************************************!*\
  !*** ./app/src/preload/ipcRendererManager.ts ***!
  \***********************************************/
/*! no static exports found */
...
Object.defineProperty(exports, "__esModule", { value: true });
var electron_1 = __webpack_require__(/*! electron */ "electron");
var IpcRendererManager = /** @class */ (function () {
    function IpcRendererManager() {
        this.invoke = electron_1.ipcRenderer.invoke.bind(electron_1.ipcRenderer);
    ...
    IpcRendererManager.prototype.handle = function (channel, callback) {
        var _this = this;
        electron_1.ipcRenderer.on(channel, function (event, key) {
            var args = [];
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, callback.apply(void 0, __spreadArrays([event], args))];
                        case 1:
                            result = _a.sent();
                            // noinspection ES6MissingAwait
                            electron_1.ipcRenderer.invoke(key, result);
                            return [2 /*return*/];
                    }
                });
            });
...
exports.default = IpcRendererManager;
...
/***/ "./app/src/preload/rendererRouter.ts":
/*!*******************************************!*\
  !*** ./app/src/preload/rendererRouter.ts ***!
  \*******************************************/
/*! no static exports found */
 ...
 */
var RendererRouter = /** @class */ (function () {
    function RendererRouter() {
        var _this = this;
        this._hardwareList = [];
        this.currentState = constants_1.HardwareStatement.disconnected;
        this.serverMode = constants_1.RunningModeTypes.server;
        var initialServerMode = electron_1.ipcRenderer.sendSync('getCurrentServerModeSync') || constants_1.RunningModeTypes.server;
        this.consoleWriteServerMode(initialServerMode);
        electron_1.ipcRenderer.removeAllListeners('hardwareListChanged');
        electron_1.ipcRenderer.removeAllListeners('hardwareCloseConfirm');
        electron_1.ipcRenderer.removeAllListeners('serverMode');
        electron_1.ipcRenderer.on('hardwareListChanged', this.refreshHardwareModules.bind(this));
        electron_1.ipcRenderer.on('hardwareCloseConfirm', this.confirmHardwareClose.bind(this));
        electron_1.ipcRenderer.on('serverMode', function (event, mode) {
            _this.consoleWriteServerMode(mode);
        });
        this._baseModulePath = electron_1.ipcRenderer.sendSync('baseModuleSync');
    }
    Object.defineProperty(RendererRouter.prototype, "hardwareList", {
        get: function () {
    ...
    Object.defineProperty(RendererRouter.prototype, "baseModulePath", {
        get: function () {
    ...
    Object.defineProperty(RendererRouter.prototype, "priorHardwareList", {
        get: function () {
    ...
    Object.defineProperty(RendererRouter.prototype, "sharedObject", {
        get: function () {
            return electron_1.remote.getGlobal('sharedObject');
        },
        enumerable: false,
        configurable: true
    });
    Object.defineProperty(RendererRouter.prototype, "currentWindow", {
        get: function () {
    ...
    RendererRouter.prototype.startScan = function (hardware) {
        electron_1.ipcRenderer.send('startScan', hardware);
    };
    ;
    RendererRouter.prototype.stopScan = function () {
        electron_1.ipcRenderer.send('stopScan');
    };
    RendererRouter.prototype.close = function () {
        electron_1.ipcRenderer.send('close');
    };
    RendererRouter.prototype.sendSelectedPort = function (portName) {
        electron_1.ipcRenderer.send('selectPort', portName);
    };
    RendererRouter.prototype.sendHandshakePayload = function (payload) {
        console.log('sendHandShakePayload', payload);
        electron_1.ipcRenderer.send('handshakePayload', payload);
    };
    RendererRouter.prototype.requestOpenAboutWindow = function () {
        electron_1.ipcRenderer.send('openAboutWindow');
    };
    RendererRouter.prototype.requestFlash = function (firmwareName) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, electron_1.ipcRenderer.invoke('requestFlash', firmwareName)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    RendererRouter.prototype.openExternalUrl = function (url) {
        electron_1.shell.openExternal(url);
    };
    RendererRouter.prototype.getOpenSourceContents = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, electron_1.ipcRenderer.invoke('getOpenSourceText')];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    RendererRouter.prototype.executeDriverFile = function (driverPath) {
        electron_1.ipcRenderer.send('executeDriver', driverPath);
    };
    RendererRouter.prototype.requestDownloadModule = function (moduleName) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, electron_1.ipcRenderer.invoke('requestDownloadModule', moduleName)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    RendererRouter.prototype.reloadApplication = function () {
        electron_1.ipcRenderer.send('reload');
    };
    RendererRouter.prototype.checkProgramUpdate = function () {
        return __awaiter(this, void 0, void 0, function () {
            var appName, translator, Modal, translate, modal;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        appName = this.sharedObject.appName;
                        translator = window.translator, Modal = window.Modal;
                        translate = function (str) { return translator.translate(str); };
                        modal = new Modal.default();
                        if (!(appName === 'hardware' && navigator.onLine)) return [3 /*break*/, 2];
                        return [4 /*yield*/, electron_1.ipcRenderer.invoke('checkUpdate')
                                .then(function (_a) {
                                ...
                                if (hasNewVersion &&
                                    ...
                                    modal.alert(translate('You can use the latest Entry Hardware version(%1).')
                                        .replace(/%1/gi, latestVersion), translate('Alert'), {
    ...
    RendererRouter.prototype.refreshHardwareModules = function () {
        // configuration
        var routerHardwareList = this.getHardwareListSync();
        this.priorHardwareList.forEach(function (target, index) {
            var currentIndex = routerHardwareList.findIndex(function (item) {
                var _a;
                var itemName = ((_a = item.name) === null || _a === void 0 ? void 0 : _a.ko) || item.name;
    ...
    RendererRouter.prototype.getHardwareListSync = function () {
        return electron_1.ipcRenderer.sendSync('requestHardwareListSync');
    };
    RendererRouter.prototype.consoleWriteServerMode = function (mode) {
        if (this.serverMode === mode) {
            return;
        }
        if (mode === constants_1.RunningModeTypes.client) {
            console.log('%cI`M CLIENT', 'background:black;color:yellow;font-size: 30px');
        }
        else if (mode === constants_1.RunningModeTypes.server) {
            console.log('%cI`M SERVER', 'background:orange; font-size: 30px');
        }
        this.serverMode = mode;
    };
    RendererRouter.prototype.confirmHardwareClose = function () {
        var translator = window.translator;
        var translate = function (str) { return translator.translate(str); };
        var isQuit = true;
        ...
        if (isQuit) {
            this.close();
            electron_1.ipcRenderer.send('hardwareForceClose', true);
        }
    };
    return RendererRouter;
}());
exports.default = RendererRouter;
...
var Translator = /** @class */ (function () {
    ...
    Object.defineProperty(Translator.prototype, "currentLanguage", {
        get: function () {
            return this.lang;
        },
        enumerable: false,
    ...
    Translator.prototype.setGlobalLang = function (lang) {
        try {
            window.Lang = __webpack_require__("./app/src/preload/lang sync recursive ^\\.\\/.*\\.js$")("./" + lang + ".js").Lang;
        }
        catch (e) {
            console.error(e);
            window.Lang = __webpack_require__(/*! ./lang/en.js */ "./app/src/preload/lang/en.js").Lang;
        }
    };
    return Translator;
}());
