#define DIGITAL_MAX_NUM 14
#define ANALOG_MAX_NUM 6
...
void initPorts () {
  for (int pinNumber = 0; pinNumber < DIGITAL_MAX_NUM; pinNumber++) {
...
void sendPinValues() {
  int pinNumber = 0;
  for (pinNumber = 0; pinNumber < DIGITAL_MAX_NUM; pinNumber++) {
    sendDigitalValue(pinNumber);
  }
  for (pinNumber = 0; pinNumber < ANALOG_MAX_NUM; pinNumber++) {
