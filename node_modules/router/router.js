...
Router.prototype.connect = function(connector, config) {
	...
	if(extension && server) {
        ...
        //     connector.connect(connector.address, connector.channel, function(a,b,c) {
        //         // connector.write(extension.requestInitialData());
        ...
        //                 var data = extension.requestLocalData();
        //                 if(data) {
        //                     connector.write(new Buffer(data), function(err, bytesWritten) {
